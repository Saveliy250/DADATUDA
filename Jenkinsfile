        ...
        stage('Docker Deploy && Deploy to ArgoCD') {
            ...
            steps {
                script {
                    ...
                    deployToArgo('ssh://git@bitbucket.dada-tuda.ru:7999/dada/dada-argo.git', 'helm/javascript/services/tg-miniapp/values-dev.yaml', result.getTag(), 'develop')
                }
            }
        }
        stage('Docker Deploy && Deploy to ArgoCD PROD') {
            ...
            steps {
                script {
                    ...
                    deployToArgo('ssh://git@bitbucket.dada-tuda.ru:7999/dada/dada-argo.git', 'helm/javascript/services/tg-miniapp/values-prod.yaml', result.getTag(), 'develop')
                }
            }
        }
    }
